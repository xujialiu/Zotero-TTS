...
reports the same way. `MEMORY/docs.md` holds the rules — read it in full
before acting; its section "The Chinese pages" is binding — and this file
says how to work them.
...
3. The rules, from MEMORY/docs.md:
