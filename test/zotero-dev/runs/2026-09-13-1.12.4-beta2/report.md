...
Case 3g observations and recorded bridge scripts. Read the [script prerequisites](scripts/README.md) before reuse. Raw user state has been redacted.
...
[Recorded script 1: Baseline snapshot](scripts/01-baseline-snapshot.js)
...
[Recorded script 2: Disable uploads and mute before playback](scripts/02-disable-uploads-and-mute-before-playback.js)
...
[Recorded script 3: Fixture import](scripts/03-fixture-import.js)
...
[Recorded script 4: Fixture open and manager readiness](scripts/04-fixture-open-and-manager-readiness.js)

[Recorded script 5: Fixture open and manager readiness](scripts/05-fixture-open-and-manager-readiness.js)
...
[Recorded script 6: Audio motion probe (before playback checks)](scripts/06-audio-motion-probe-before-playback-checks.js)
...
[Recorded script 7: English UI probe](scripts/07-english-ui-probe.js)
...
[Recorded script 8: Real provider request capture](scripts/08-real-provider-request-capture.js)
...
[Recorded script 9: Empty pair and prefetch](scripts/09-empty-pair-and-prefetch.js)
...
[Recorded script 10: Session setting and cache probes](scripts/10-session-setting-and-cache-probes.js)

[Recorded script 11: Session setting and cache probes](scripts/11-session-setting-and-cache-probes.js)

[Recorded script 12: Session setting and cache probes](scripts/12-session-setting-and-cache-probes.js)
...
[Recorded script 13: Exact cache-repeat probe](scripts/13-exact-cache-repeat-probe.js)
...
[Recorded script 14: Exact source-position equality probe](scripts/14-exact-source-position-equality-probe.js)
...
[Recorded script 15: Native stub](scripts/15-native-stub.js)
...
[Recorded script 16: Exact fixture cleanup script](scripts/16-exact-fixture-cleanup-script.js)
...
[Recorded script 17: Exact preference restore script (memory literal redacted)](scripts/17-exact-preference-restore-script-memory-literal-redacted.redacted.js.txt)
...
[Recorded script 18: Settings pane restoration after timeout](scripts/18-settings-pane-restoration-after-timeout.js)

The fallback that actually restored General was:

[Recorded script 19: Settings pane restoration after timeout](scripts/19-settings-pane-restoration-after-timeout.js)

[Recorded script 20: Settings pane restoration after timeout](scripts/20-settings-pane-restoration-after-timeout.js)
