(async () => {
  ...
  const segment = Object.freeze({
    ...
    sourcePosition: { type: 'FragmentSelector', value: 'issue-101-custom' },
  });
  ...
  return JSON.stringify({ source, configuredPairs: Zotero.Prefs.get('zotero-tts.readAloud.bracketPairs'), voiceID, calls, result, error }, null, 1);
})()
