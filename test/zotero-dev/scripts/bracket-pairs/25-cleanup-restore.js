(async () => {
  ...
  const baseline = globalThis.__zttsBracketPairsBaseline;
  ...
  for (const suffix of ['readAloud.volume', 'readAloud.stripAngleBrackets', 'readAloud.bracketPairs', 'cacheAudio', 'prefetchEnabled', 'webdav.syncSettings']) restore(suffix);
  ...
  try {
    ...
    } else cleanup.settingsClosed = !win;
  ...
  const finalPrefs = {};
  for (const suffix of ['readAloud.volume', 'readAloud.stripAngleBrackets', 'readAloud.bracketPairs', 'cacheAudio', 'prefetchEnabled', 'webdav.syncPositions', 'webdav.autoUploadSettings', 'webdav.syncSettings', 'readAloud.memory']) finalPrefs[suffix] = read(suffix);
  let position = null;
