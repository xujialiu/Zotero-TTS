return (async () => {
  ...
  rw.addEventListener('keydown', listener, true); rw.document.addEventListener('keydown', listener, true);
  ...
  rw.removeEventListener('keydown', listener, true); rw.document.removeEventListener('keydown', listener, true);
