return (async () => {
  ...
  const root = {
    version: 'issue-100-live-beta4',
    createdAt: stamp,
    pdf: { itemID: null, key: null, title: 'Zotero-TTS issue 100 PDF fixture beta4 ' + stamp, reader: null },
    epub: { itemID: null, key: null, title: 'Zotero-TTS issue 100 EPUB fixture beta4 ' + stamp, reader: null },
  };
