(async () => {
  const file = '/Users/xujialiu/orca/workspaces/Zotero-TTS/bug/test/fixtures/angle-brackets/angle-brackets.epub';
  try {
    const imported = await Zotero.Attachments.importFromFile({
      file,
      libraryID: Zotero.Libraries.userLibraryID,
      title: 'Zotero-TTS issue 101 configurable bracket pairs',
    });
