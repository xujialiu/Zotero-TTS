...
| 2026-09-17 / 1.12.12-beta5 | Reusable baseline/transport/clock PASS in PDF/EPUB after macOS path fix; native managers paused on `native119-a` and clocks advanced | `2026-09-17-1.12.12-beta5-playback-notice-voice-bootstrap-r2` |
