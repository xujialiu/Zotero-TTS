...
Expected cleanup is zero fixture readers/items, the original tab and user reader unchanged, the original memory/native voice map and headers equal to baseline, and position rows/queue unchanged. The sanitized outputs from this run are [the beta5 evidence](../../runs/2026-09-13-1.12.5-beta5/evidence.json) and [the beta5 report](../../runs/2026-09-13-1.12.5-beta5/report.md).
