...
ztts-heading-fish-sources = 语音来源
...
ztts-help-fish-include-manual =
    .value = ?
    .help = 下面填入的 Model IDs。关闭后，IDs 仍保留在这里，但这些语音不会进入自动列表。
...
ztts-help-fish-model-ids =
    .value = ?
    .help = 粘贴一个或多个 Fish Audio Model ID 或链接，用逗号或空格隔开。可在 https://fish.audio/app/discovery/ 查找 Model IDs。
ztts-fish-discovery-link = 查找 Model IDs
ztts-fish-manual-disabled = 手动语音已关闭，已保存的 Model IDs 仍保留在这里。
ztts-fish-refresh =
    .label = 刷新 Fish 列表
ztts-heading-fish-speech = 本地
...
ztts-fish-refreshing = 正在刷新 Fish Audio 语音…
ztts-fish-refreshed = Fish Audio 语音已刷新。
ztts-fish-refresh-error = Fish Audio 刷新失败：{ $detail }
ztts-fish-refresh-cancelled = 朗读打开时已取消刷新。
ztts-fish-refresh-timeout = Fish Audio 在 { $seconds } 秒内没有回复。
ztts-fish-refresh-stale = 刷新时 Fish Audio 设置发生了变化，请重新刷新。
ztts-fish-refresh-unavailable = 请先启用 Fish Audio，再刷新语音列表。
