...
ztts-help-keep-following-visible =
    .value = ?
    .help = 默认开启。在 PDF 和 EPUB 中，滚动或导航让整句高亮完全离开视图时暂停自动滚动；当前句子有任意一部分重新可见时，自动恢复跟随。移动页面期间，自动滚动会暂时等待。关闭后，滚动或导航会立即退出跟随，需使用“回到朗读位置”或跳转按钮恢复。
...
ztts-help-key-voice =
    .value = ?
    .help = 按播放器当前声音列表循环切换。播放时，旧声音会继续朗读，等新声音准备好后，在单词结束处交接；必要时改在句子之间交接。暂停时只更换声音。准备声音可能消耗服务额度，即使你随后选择了其他声音。
...
ztts-voice-failed = 无法切换到 { $voice }。请重试，或暂停后再更换声音。
