...
ztts-help-fish =
    .value = ?
    .help = The key is on the Developers page of your fish.audio account. Listed: the voices you made there, the ones you paste below, and the model's default voice — with word highlighting. The free model costs nothing but keeps your requests, promises no speed, and may end; the paid one bills by the byte of text, three per Chinese character.
ztts-fish-free-only =
...
ztts-fish-voices-input =
    .placeholder = ids or links from fish.audio
ztts-help-fish-voices =
    .value = ?
    .help = Open a voice on fish.audio and paste its link or its id here; several, separated by commas or spaces. Your own voices need no pasting.
ztts-heading-fish-speech = Fish Speech server (your own)
