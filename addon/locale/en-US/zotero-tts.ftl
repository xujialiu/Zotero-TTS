...
ztts-heading-fish-sources = Voice sources
...
ztts-help-fish-include-manual =
    .value = ?
    .help = Model IDs entered below. Turn this off to keep the IDs saved but leave those voices out of the automatic list.
ztts-field-model-ids =
    .value = Model IDs
ztts-fish-model-ids-input =
    .placeholder = IDs from Fish Audio
ztts-help-fish-model-ids =
    .value = ?
    .help = Paste one or more Fish Audio Model IDs or links, separated by commas or spaces. Find Model IDs at https://fish.audio/app/discovery/.
ztts-fish-discovery-link = Find Model IDs
ztts-fish-manual-disabled = Manual voices are off. Saved Model IDs stay in this field.
ztts-fish-refresh =
    .label = Refresh Fish list
ztts-heading-fish-speech = Local
...
ztts-fish-refreshing = Refreshing Fish Audio voices…
ztts-fish-refreshed = Fish Audio voices refreshed.
ztts-fish-refresh-error = Fish Audio refresh failed: { $detail }
ztts-fish-refresh-cancelled = Refresh cancelled while Read Aloud is open.
ztts-fish-refresh-timeout = Fish Audio did not reply within { $seconds } seconds.
ztts-fish-refresh-stale = Fish Audio settings changed while refreshing. Refresh again.
ztts-fish-refresh-unavailable = Enable Fish Audio before refreshing its voice list.
