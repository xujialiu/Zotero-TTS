...
ztts-help-key-voice =
    .value = ?
    .help = Cycle through the player's current voice list. While playing, the old voice continues until the new one is ready, then hands over at a word boundary, or between sentences when necessary. While paused, only the voice changes. Preparing a voice may use your provider's quota, even if you change your mind.
...
ztts-voice-failed = Could not switch to { $voice }. Try again, or pause before changing the voice.
